...
def initialize(number):
    ...
    points = pd.read_csv('F:/Scientific_Literature/写论文/test_data/Zimbabwe - 929.csv', usecols=[1, 2]).values
...
if __name__ == "__main__":
    ...
    for index in range(number):
        ...
        for j in range(1, 100):
            ...
            temp_opt, ball_center, mec_count = main()
    ...
    df.to_csv('C:/Users/74412/Desktop/article/k_center/SDF_Zimbabwe.csv')
